module fenture::acoin_lend {
    ...
    use fenture::market;
    use fenture::market_storage;
    use fenture::interest_rate_module;
    use fenture::acoin::{Self, ACoin};
    use fenture::constants::{Exp_Scale, Borrow_Rate_Max_Mantissa, Reserve_Factor_Max_Mantissa};
    ...
    public entry fun register<CoinType>(account: &signer) {
        ...
        if (!coin::is_account_registered<FentureFinanceDao>(signer::address_of(account))) {
            coin::register<FentureFinanceDao>(account);
        };
    }
